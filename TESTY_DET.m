...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ostateczna
% skrypt testowy do metod obliczających wyznacznik macierzy
% trójdiagonalnej:
% metody wykorzystującej GE i metody wykorzystującej zależności między
% minorami głównymi
% w pierwszej kolejności zostało ręcznie wypisanych 12 przykładów (skrajne,
% ciekawe przypadki np. z liczbami zespolonymi)
% następnie skorzystano z funkcji testującej wybraną ilość macierzy
% generowanych losowo o wartościach losowych
...
disp('TEST metGE')
test_(500,0); %UWAGA liczba po znaku plus jest liczbą przypadków, gdy metoda GE jest nie wykonalna 
